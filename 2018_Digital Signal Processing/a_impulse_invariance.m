...
%% (a) - 1 Digital Type 2 Chebyshev LPF with Impulse Invariance Method %%
...
%% Apply impulse invariance method and obtain digital filter coefficient
tf2sos(b, a)
[b_z, a_z] = impinvar(b, a, 1/T_d);
