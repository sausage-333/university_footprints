...
%% (b) - 1 Digital Type 2 Chebyshev LPF with Impulse Invariance to HPF using Frequency Transformation %%
...
%% Apply to Impulse invariance and make Digital Filter coefficient
tf2sos(b, a)
[pre_b_z, pre_a_z] = impinvar(b, a, 1/T_d);

w_d = 0.6 * pi;
[b_z, a_z] = iirlp2hp(pre_b_z, pre_a_z, w_p / pi, w_d / pi);
